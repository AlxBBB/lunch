...
public class VoteTestData {
    ...
    public static final Vote USER1_VOTE1 = new Vote(START_SEQ+10, LocalDate.now().minusDays(1),RESTAURANT1);
    public static final Vote USER1_VOTE2 = new Vote(START_SEQ+11, LocalDate.now(),RESTAURANT1);
